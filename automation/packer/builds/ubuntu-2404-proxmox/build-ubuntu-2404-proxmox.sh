#!/usr/bin/env bash
# =============================================================================
# Ubuntu 24.04 Golden Image — Proxmox build wrapper (Linux)
# Runs the Packer build for the ubuntu-2404-proxmox template. Works three ways:
#
#   1. STANDALONE (interactive) — any Linux box with packer + ansible:
#        ./build-ubuntu-2404-proxmox.sh
...
#      creates a "Build Golden Image — Ubuntu 24.04" task template that runs
#      this script with the Proxmox variable group providing credentials.
#
#   3. Pure packer — see the header of ubuntu-2404-proxmox.pkr.hcl.
#
...
#
# Output: Proxmox template "t-ubuntu-2404-<timestamp>" (VMID 9004 by
...
log "Done. New template: check 't-ubuntu-2404-<timestamp>' (VMID 9004) in Proxmox."

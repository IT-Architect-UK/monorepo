...
if [[ -n "${ADMIN_USERNAME}" ]]; then
    ...
    # NOTE: SSH password access for this account is granted via the common
    # role's sshd_config template (ssh_password_auth_users), set by the
    # self-provisioning step at the end of the build. Appending to
    # sshd_config here would be overwritten by that template — confirmed on
    # a real build (2026-07-02).

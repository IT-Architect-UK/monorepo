---
slug: hypervisor-build
title: Hypervisor host built — Proxmox or Hyper-V
status: skeleton
---

## likely

What the site promises for this service (Virtualisation Platforms page):

- Platform design and capacity planning
- Build and migration of existing servers
- High availability and resilience
- Backup, replication and tested recovery
...
> Time budget 240 min. Tick as you go; write what you actually found in the right-hand column — it becomes the CRM note and the customer's summary.

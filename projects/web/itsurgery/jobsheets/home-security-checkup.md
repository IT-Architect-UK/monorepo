---
slug: home-security-checkup
title: Security — malware scanning, application reviews, password & authentication management & more
status: skeleton
---

## likely

What the site promises for this service (Malware Removal page):

- Virus and malware removal
- Scam pop-ups and fake warnings dealt with
- Suspicious email and message checks
- Protection installed and configured
- Plain-English advice on staying safe
...
> Time budget 90 min. Tick as you go; write what you actually found in the right-hand column — it becomes the CRM note and the customer's summary.

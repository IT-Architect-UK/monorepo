---
slug: backup-setup-and-test
title: Backup set up, and tested by actually restoring it
status: skeleton
---

## likely

What the site promises for this service (Cyber Security page):

- Security review and risk assessment
- Firewall and endpoint protection
- Patching and vulnerability management
- Backup and recovery testing
- Staff awareness and phishing guidance

---
slug: home-ai-automation
title: AI automation for repeat tasks, emails, documents & development
status: skeleton
---

## likely

What the site promises for this service (AI Help & Training page):

- A friendly, jargon-free introduction to what AI can and cannot do
- Setting up ChatGPT, Claude or Gemini on your computer, phone or tablet
- Using it for real things — letters, forms, holiday planning, making sense of documents
- Help with photos, recipes, hobbies and learning something new
...
- [ ] This job sheet (printed) and a pen. Leaflets and a business card.

## steps

> Time budget 120 min. Tick as you go; write what you actually found in the right-hand column — it becomes the CRM note and the customer's summary.

### A. Arrive and triage   Arrived: ________
...
- [ ] Ask for a Google review while you are there — open the link on their phone if they are willing. Leave leaflet and card.
...
- Arrived / left: ________  /  ________     Total: ________ min
- Cause found
- Done / changed
- Advice given
- Follow-up offered
